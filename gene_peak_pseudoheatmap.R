...
library(pheatmap)
TF_gene <- read.delim("C:/Users/LSCS/Desktop/tenet/CD8_merge_TF/TF_gene.sif", header=FALSE)
TF_peak <- read.delim("C:/Users/LSCS/Desktop/tenet/CD8_merge_TF/TF_peak.sif", header=FALSE)
...
temp2 <- order_peusodata2(matrix,top_20_sif,trajectory)
temp2 <- pseudo_heatmap(temp2,0.7)
dim(temp2)
pheatmap(temp2[2:22,], show_colnames=F, cluster_rows = F, cluster_cols = F,main="SPI1_related_top20_gene_by_TENET pserudotime_expression")
pheatmap(temp2[2:8,], show_colnames=F, cluster_rows = F, cluster_cols = F,main="IKZF3_related_top20_peak_by_TENET pserudotime_expression")

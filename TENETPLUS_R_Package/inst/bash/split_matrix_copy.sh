...
grep -Ff <(cut -f 1 TE_peak_list.comm.tmp) $TE_mtrx > ${TE_mtrx%.txt}_rowPeak.txt
...
TF_list="GO_symbol_human_regulation_of_transcription+sequence-specific_DNA_binding_list.txt"
